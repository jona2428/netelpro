"""Tarea RLVR: el string más largo entre dos, con empate a favor del primero."""
...
TASK_ID = "longest_of_two"
DESCRIPTION_ES = (
    "Escribí una función que reciba dos strings a y b, y devuelva el que "
    "tenga más caracteres. Si tienen el mismo largo, devolvé a."
)
SIGNATURE = "(defn longest-of-two (a b) ...)"
FN_NAME = "longest-of-two"
...
assert reference("hola", "hi") == "hola"
assert reference("hi", "hola") == "hola"
