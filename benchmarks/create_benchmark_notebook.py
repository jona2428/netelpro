...
def build_benchmark_notebook() -> dict:
    cells = [
        ...
        },
        {
            ...
            "outputs": [],
            "source": [
                "# Instalación de librerías para evaluación e inferencia (soporte GGUF y tokenizers)\n",
                "!pip install -q -U \"transformers>=4.49.0\" peft accelerate bitsandbytes datasets tabulate pandas gguf sentencepiece tiktoken\n"
            ]
        },
        {
            "cell_type": "markdown",
        ...
        },
        {
            ...
            "source": [
                ...
                "    \n",
                "    # Detectar si el repositorio de Hugging Face aloja un archivo GGUF\n",
                "    gguf_filename = None\n",
                "    if \"qwen2.5-1.5b-honest\" in model_name.lower():\n",
                "        gguf_filename = \"netelpro-qwen2.5-1.5b-q4_k_m.gguf\"\n",
                "        tokenizer_id = \"Qwen/Qwen2.5-1.5B-Instruct\"\n",
                "    elif \"lfm2.5-1.2b-honest\" in model_name.lower():\n",
                "        gguf_filename = \"netelpro-lfm2.5-1.2b-honest.gguf\"\n",
                ...
                "    \n",
                "    if gguf_filename:\n",
                "        print(f\"  📦 Detectado formato GGUF: cargando {gguf_filename}...\")\n",
