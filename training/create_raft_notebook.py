    ...
    cells = [
        {
            ...
            "source": [
                ...
                "5 rondas con pool acumulado (v2, RAFT canónico), medido contra un split held-out (OOD) que el loop nunca entrena.\n",
                "\n",
                "---\n",
        ...
        },
        {
            ...
            "metadata": {},
            "source": [
                "## 7. Loop RAFT iterativo",
                "",
                "**v2 -- pool acumulado:** cada ronda SFT entrena sobre TODO el harvest verificado hasta ahora "
                "(no solo el fresco) -- RAFT canónico; evita el forgetting que planchó la ronda 2 de la v1.",
            ],
        },
        {
            "cell_type": "code",
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 10. Reporte final (trayectoria + detalle por tarea)"],
        },
        {
            "cell_type": "code",
            "execution_count": None,
        ...
        },
        {
            "cell_type": "markdown",
            "metadata": {},
            "source": ["## 11. Descargar resultados (GGUF + reporte)"],
        },
        {
            "cell_type": "code",
            "execution_count": None,
